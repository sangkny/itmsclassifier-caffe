...
if __name__ == '__main__':
    ...
    batchDir = 'D:\\sangkny\\dataset\\verify\\classes\\1' #args.batchDir    # batch directory
    #batchDir = 'C:\\Users\\mmc\\Downloads\\new_sample\\nobj'  # args.batchDir    # batch directory
    gt_class = os.path.split(batchDir)[-1]  # ground truth class

    incFileDir = 'D:\\sangkny\\dataset\\verify\\classes\\incorrect_20200328' # incorrect folder base
